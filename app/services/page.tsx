...
const LANES = [
  ...
  },
  {
    ...
    description:
      "Replace the 5+ tools you are paying for separately with one platform that captures leads, follows up automatically, manages your pipeline, and has an AI assistant working it around the clock.",
